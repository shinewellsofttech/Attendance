...
const API_URL = `${API_WEB_URLS.MASTER}/0/token/MachineTypeMaster`;

const PageList_MachineTypeMasterContainer = () => {
  ...
  const handleDelete = async (id: number) => {
    const confirmed = window.confirm("Are you sure you want to delete this machine type?");
    if (confirmed) {
      try {
  ...
  const handleAdd = () => {
    navigate("/addEdit_MachineTypeMaster", { state: { Id: 0 } });
  };
  ...
  return (
    <>
      <Breadcrumbs mainTitle="Machine Type Master List" parent="Masters" />
      <Container fluid>
        <Row>
          <Col xs="12">
            <Card>
              <CardHeaderCommon
                title="Machine Type Master List"
                ...
                <Row className="mb-3">
                  ...
                  <Col md="6" className="text-end">
                    <Btn
                      ...
                      onClick={handleAdd}
                    >
                      <i className="fa fa-plus me-2"></i>Add New Machine Type
                    </Btn>
                  </Col>
                </Row>
                {loading ? (
...
export default PageList_MachineTypeMasterContainer;
